...
export default function FinanceScreen() {
  ...
  let barCode = '000.84654.0004134.8798.711203.014867982.125465.153.15468432132.014687.54165487.123.12334'
  let open = 0
  Content = null
  ...
  toggleMenu = () => {
    ...
    //Atualiza status da parcela selecionado
    showMe == false ? 
    setShowMe(true) : setShowMe(false)
                ...
                <View style={{
                  ...
                  <View style={{marginBottom: 5,justifyContent: 'space-between',flexDirection: 'row'}}>
                    ...
                    <View style={{alignSelf: 'center', marginVertical: 5}}>
                      <TouchableWithoutFeedback  onPress={copyBarCode}>
                        <View style={{
