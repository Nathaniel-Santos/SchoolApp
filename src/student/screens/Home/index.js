          ...
          <StatusBar backgroundColor="#003d6b" barStyle="light-content" />
            ...
            <View style={styles.container1}>
              <TouchableOpacity 
                ...
                <Image style={{width: 65, height: 65}} source={require('../../../img/notes.png')} />
                <Text style={styles.texto}>BOLETIM</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.botao}
              onPress={()=>this.props.navigation.navigate('Finance')}>
                <Image style={{width: 65, height: 65}} source={require('../../../img/finance.png')} />
            ...
            <View style={styles.container2}>
              <TouchableOpacity style={styles.botao}>
                <Image style={{width: 65, height: 65}} source={require('../../../img/warn.png')} />
                <Text style={styles.texto}>OCORRÊNCIAS</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.botao}>
                <Image style={{width: 65, height: 65}} source={require('../../../img/chat.png')} />
